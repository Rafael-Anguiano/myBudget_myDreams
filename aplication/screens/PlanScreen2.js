...
export default class SavingPlan2 extends React.Component {
    constructor(props) {
        super(props);
        this.state = {
            reason: undefined,
                        ...
                        <Card style={{borderColor:'#EFF1FE'}}>
                            <CardItem>
                                <Left>
                                    ...
                                    <Body>
                                        <Text note>Plan:<Text style={{fontWeight:'bold'}}> {reason}</Text></Text>
                                        <Text note> Saving:<Text style={{fontWeight:'bold'}}> $ {amount}</Text></Text>
                                        <Text note> Total Saved:<Text style={{fontWeight:'bold'}}> $ {biweeklyPay}</Text></Text>
