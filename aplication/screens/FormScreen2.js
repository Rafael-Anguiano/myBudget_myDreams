...
export default class SavingForm2 extends React.Component {
    constructor(props) {
        super(props);
        this.state = {
            reason: undefined,
            ...
            <View style={styles.container}>
                ...
                <View style={{ marginVertical:25 }}>
                    <Item floatingLabel style={this.state.errorAmount ? styles.emptyField : styles.field}>
                        <Label style={styles.label}> Saving Amount per month: </Label>
                        <Input 
                    ...
                    { this.state.errorAmount && <Text style={{color:'#9A393B', fontWeight:'bold'}}> Enter your Saving Amount per Month </Text> }
                </View>
